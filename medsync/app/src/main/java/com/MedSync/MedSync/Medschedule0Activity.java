...
public class Medschedule0Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.medschedule0);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_databasemed_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				databasemed.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
